...
router.post('/register', (0, validate_1.validate)(agent_schema_1.registerUserSchema), auth_controller_1.registerAgentHandler);
router.post('/login', (0, validate_1.validate)(agent_schema_1.loginUserSchema), auth_controller_1.loginAgentHandler);

...
warehouseRouter.get(base + '/', auth_1.auth, warehouse_controller_1.viewWarehousesHandler);
warehouseRouter.get(base + '/:id', auth_1.auth, warehouse_controller_1.viewWarehouseHandler);

...
authRouter.get('/users', deserializeUser_1.auth, deserializeUser_1.adminAuth, auth_controller_1.getUsersHandler);
...
authRouter.patch('/user/:id', (0, validate_1.validate)(user_schema_1.updateUserSchema), deserializeUser_1.auth, deserializeUser_1.adminAuth, auth_controller_1.updateUserHandler);

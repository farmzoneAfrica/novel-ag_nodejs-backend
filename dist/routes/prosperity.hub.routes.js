...
const base = "";
prosperityHubrouter.post(base + '/create', (0, validate_1.validate)(prosperityHub_schema_1.createProsperityHubSchema), deserializeUser_1.auth, requireUser_1.requireUser, prosperityHub_controller_1.createProsperityHubHandler);
...
prosperityHubrouter.patch(base + '/update/:id', (0, validate_1.validate)(prosperityHub_schema_1.updateProsperityHubSchema), deserializeUser_1.auth, prosperityHub_controller_1.updateProsperityHubHandler);

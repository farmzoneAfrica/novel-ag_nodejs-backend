...
farmRouter.post('/:user_id', deserializeUser_1.auth, (0, validate_1.validate)(farm_schema_1.createFarmSchema), farm_controller_1.createFarmHandler);
...
farmRouter.patch('/:id', deserializeUser_1.auth, (0, validate_1.validate)(farm_schema_1.updateFarmSchema), farm_controller_1.updateFarmHandler);
farmRouter.delete('/:id', deserializeUser_1.auth, farm_controller_1.deleteFarmHandler);
